...
2. Em **Variables**, adicione os pares nome/valor listados em `VARIABLES.md` (AWS_REGION, TASK_IMAGE, ECR_REPOSITORY, EKS_CLUSTER_NAME, K8S_NAMESPACE, DEPLOYMENT_NAME, ADMIN_SECRET_NAME; opcional `PROJECT` para prefixos da IaC).
